...
if C.unitframes.castbarTicks ~= true then return end
...
local function SpellName(id)
    ...
    if spellInfo and spellInfo.name then
        ...
        print("|cffff0000RefineUI: ChannelingTicks spell ID ["..tostring(id).."] no longer exists!|r")
        return "Empty"
    end
end
...
f:SetScript("OnEvent", function()
	...
	R.CastBarTicks[SpellName(47540)] = penanceTicks
end)
