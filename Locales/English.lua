...
-- Popups
L_POPUP_INSTALLUI = "First time on RefineUI with this Character. You must reload UI to configure it."
L_POPUP_RESETUI = "Are you sure you want to reset all settings for RefineUI?"
...
L_POPUP_DISABLEUI = "RefineUI doesn't work for this resolution, do you want to disable RefineUI? (Cancel if you want to try another resolution)"
...
-- Welcome message
L_WELCOME_LINE_1 = "Welcome to RefineUI "
L_WELCOME_LINE_2_1 = "Type /cfg to config interface, or visit https://github.com/Wetxius/RefineUI_Help/wiki/English"
...
-------------------- MODULES ---------------------------
L_MODULES = "Modules"
L_LEFTCLICK = "Left Click"
L_RIGHTCLICK = "Right Click"
L_K = "K"
L_M = "M"
L_B = "B"
L_L = "L"
...
L_MICROMENU = "Micromenu"
L_SHOW_SOCIAL_TOOLTIPS = "Show Social Tooltips"
L_MAIN_MENU_ICON_RIGHT_SPACING = "Main Menu Icon Right Spacing"
L_ICON_SPACING = "Icon Spacing"
L_HIDE_BNET_APP_FRIENDS = "Hide BNet App Friends"
L_OPEN_GUILD_PAGE = "Open Guild Page"
L_NO_TAG = "No Tag"
L_WHISPER_BNET = "Whisper BNet"
L_WHISPER_CHARACTER = "Whisper Character"
L_HIDE_SOCIAL_TEXT = "Hide Social Text"
L_SOCIAL_TEXT_OFFSET = "Social Text Offset"
L_GMOTD_IN_TOOLTIP = "Gmotd In Tooltip"
L_MODIFIER_FOR_FRIEND_INVITE = "Modifier For Friend Invite"
L_SHOW_HIDE_BUTTONS = "Show/Hide Buttons"
L_SHOW_MENU_BUTTON = "Show Menu Button"
L_SHOW_CHAT_BUTTON = "Show Chat Button"
L_SHOW_GUILD_BUTTON = "Show Guild Button"
L_SHOW_SOCIAL_BUTTON = "Show Social Button"
L_SHOW_CHARACTER_BUTTON = "Show Character Button"
L_SHOW_SPELLBOOK_BUTTON = "Show Spellbook Button"
L_SHOW_TALENTS_BUTTON = "Show Talents Button"
L_SHOW_ACHIEVEMENTS_BUTTON = "Show Achievements Button"
L_SHOW_QUESTS_BUTTON = "Show Quests Button"
L_SHOW_LFG_BUTTON = "Show Lfg Button"
L_SHOW_JOURNAL_BUTTON = "Show Journal Button"
L_SHOW_PVP_BUTTON = "Show Pvp Button"
L_SHOW_PETS_BUTTON = "Show Pets Button"
L_SHOW_SHOP_BUTTON = "Show Shop Button"
L_SHOW_HELP_BUTTON = "Show Help Button"
L_NO_INFO = "No Info"
L_CLASSIC = "Classic"
L_ALLIANCE = "Alliance"
L_HORDE = "Horde"

L_DURABILITY_WARNING_THRESHOLD = "Durability Warning Threshold"
L_SHOW_ITEM_LEVEL = "Show Item Level"
L_SHOW_COORDINATES = "Show Coordinates"

L_MASTER_VOLUME = "Master Volume"
L_VOLUME_STEP = "Volume Step"

L_TIME_FORMAT = "Time Format"
L_USE_SERVER_TIME = "Use Server Time"
L_NEW_EVENT = "New Event!"
L_LOCAL_TIME = "Local Time"
L_REALM_TIME = "Realm Time"
L_OPEN_CALENDAR = "Open Calendar"
L_OPEN_CLOCK = "Open Clock"
L_HIDE_EVENT_TEXT = "Hide Event Text"

L_TRAVEL = "Travel"
L_PORT_OPTIONS = "Port Options"
L_READY = "Ready"
L_TRAVEL_COOLDOWNS = "Travel Cooldowns"
L_CHANGE_PORT_OPTION = "Change Port Option"

L_ALWAYS_SHOW_SILVER_AND_COPPER = "Always Show Silver And Copper"
L_SHORTEN_GOLD = "Shorten Gold"
L_TOGGLE_BAGS = "Toggle Bags"
L_SESSION_TOTAL = "Session Total"
L_DAILY_TOTAL = "Daily Total"
L_GOLD_ROUNDED_VALUES = "Gold Rounded Values"

L_SHOW_XP_BAR_BELOW_MAX_LEVEL = "Show Xp Bar Below Max Level"
L_USE_CLASS_COLORS_FOR_XP_BAR = "Use Class Colors For Xp Bar"
L_SHOW_TOOLTIPS = "Show Tooltips"
L_TEXT_ON_RIGHT = "Text On Right"
L_CURRENCY_SELECT = "Currency Select"
L_FIRST_CURRENCY = "First Currency"
L_SECOND_CURRENCY = "Second Currency"
L_THIRD_CURRENCY = "Third Currency"
L_RESTED = "Rested"

L_SHOW_WORLD_PING = "Show World Ping"
L_NUMBER_OF_ADDONS_TO_SHOW = "Number Of Addons To Show"
L_ADDONS_TO_SHOW_IN_TOOLTIP = "Addons To Show In Tooltip"
L_SHOW_ALL_ADDONS_IN_TOOLTIP_WITH_SHIFT = "Show All Addons In Tooltip With Shift"
L_MEMORY_USAGE = "Memory Usage"
L_GARBAGE_COLLECT = "Garbage Collect"
L_CLEANED = "Cleaned"

L_USE_CLASS_COLORS = "Use Class Colors"
L_COOLDOWNS = "Cooldowns"
L_TOGGLE_PROFESSION_FRAME = "Toggle Profession Frame"
L_TOGGLE_PROFESSION_SPELLBOOK = "Toggle Profession Spellbook"


L_SET_SPECIALIZATION = "Set Specialization"
L_SET_LOADOUT = "Set Loadout"
L_SET_LOOT_SPECIALIZATION = "Set Loot Specialization"
L_CURRENT_SPECIALIZATION = "Current Specialization"
L_CURRENT_LOOT_SPECIALIZATION = "Current Loot Specialization"
L_ENABLE_LOADOUT_SWITCHER = "Enable Loadout Switcher"
L_TALENT_MINIMUM_WIDTH = "Talent Minimum Width"
L_OPEN_ARTIFACT = "Open Artifact"
L_REMAINING = "Remaining"
L_AVAILABLE_RANKS = "Available Ranks"
L_ARTIFACT_KNOWLEDGE = "Artifact Knowledge"

-- Travel
L_USE_RANDOM_HEARTHSTONE = "Use Random Hearthstone"
L_EMPTY_HEARTHSTONES_LIST = "If you see an empty list, /reload your UI a few seconds after the initial loading (Blizzard is loading items informations asynchronously so that's the only solution for now)."
L_HEARTHSTONES_SELECT = "Hearthstones Select"
L_HEARTHSTONES_SELECT_DESC = "Select which hearthstones to use (be careful if you select multiple hearthstones, you might want to check the 'Hearthstones Select' option)"
...
L_SLASHCMD_HELP = {
	...
	"/resetconfig - Resets RefineUI_Config settings.",
