	...
	function handler:TRADE_SKILL_LIST_UPDATE()
		for index, value in pairs(buttonList) do
			if value[3]() then
				...
				buttons[index]:SetBackdropBorderColor(unpack(C.media.borderColor))
			end
		end
	end
...
if R.class == "DEATHKNIGHT" then spells[#spells + 1] = 53428 end -- Runeforging
if R.class == "ROGUE" then spells[#spells + 1] = 1804 end        -- Pick Lock
